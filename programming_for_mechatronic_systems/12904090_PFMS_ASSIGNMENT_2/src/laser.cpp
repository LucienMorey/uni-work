...
#include <algorithm>
/**
 * @brief Construct a new Laser:: Laser object Sets all default paramaters and creates object
 *
 */
Laser::Laser()
{
...
/**
 * @brief Angle reseolution setter. returns true if an allowable paramater was parsed and set else returns false
 *
 * @param angle_resolution unsigned int angle resolution to be set
 * @return true
 * @return false
 */
...
/**
 * @brief Field of view setter. returns true if set an an allowable paramater was parsed and set else false
 *
 * @param field_of_view Unsigned int field of view to be set
 * @return true if sucessfully set FOV
 * @return false if fail to set FOV
 */
...
/**
 * @brief Generate laser data vector. there will be (FOV/angle_res)+1 samples. value is capped at min and max ange of
 * laser
 *
 * @return std::vector<double>  raw laser data
 */
